...
num_trees_part1 = num_trees_for_slope(3, 1)
print("Part 1: num trees = $(num_trees_part1)\n")

# Slopes for part 2 as (right, down) tuples
part2_slopes = [(1, 1), (3, 1), (5, 1), (7, 1), (1, 2)]

part2_answer = prod(part2_slopes) do (slope_right, slope_down)
  return num_trees_for_slope(slope_right, slope_down)
end
